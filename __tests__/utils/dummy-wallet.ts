...
export const walletState = {
	...
	blacklistedUtxos: { bitcoin: [], bitcoinTestnet: [], timestamp: null },
	balance: { bitcoin: 0, bitcoinTestnet: 133456, timestamp: null },
	lastUpdated: { bitcoin: 0, bitcoinTestnet: 0, timestamp: null },
	...
	transaction: {
		...
		bitcoinTestnet: {
			...
			changeAddress: 'tb1qavg2wpnkucp8p0tg9mug8aa6m373peqvjpau3j',
			fiatAmount: 0,
			fee: 250,
			satsPerByte: 1,
			recommendedFee: 1,
